...
const url = "https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=pt-BR&page=5&sort_by=popularity.desc";
      ...
      <div className="grid grid-cols-5 gap-10">
        {movies.map((filme) => (
          ...
          >
            ...
            ></img>
            <h1 className="mb-2 font-semibold text-slate-900">{filme.name}</h1>
          </button>
        ))}
      </div>
    </div>
