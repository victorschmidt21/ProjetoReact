  ...
  return (
    <div className="bg-slate-800 w-full h-screen">
      ...
      <div className="bg-white w-72 h-36 p-3 rounded-lg flex justify-center items-center flex-col gap-1">
        ...
        <h2 className="text-slate-800 text-lg font-semibold">Página não encontrada</h2>
        <Link to="/" className="bg-slate-800 py-1 px-2 text-white rounded-md">Vá para a página Home</Link>
      </div>
      </div>
    </div>
  );
